/** ISO 3166-1 alpha-2 countries for checkout billing address. */
export const CHECKOUT_COUNTRIES: ReadonlyArray<{ code: string; label: string }> = [
...
export function toStripeCountryCode(input: string): string | null {
  ...
  if (/^[A-Za-z]{2}$/.test(raw)) {
    ...
    return CHECKOUT_COUNTRIES.some((c) => c.code === code) ? code : null;
  }
